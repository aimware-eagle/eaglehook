...
cslider = gui.Slider(gui.Reference("Settings","EagleHook","Visuals"), "cslider", "Overlay Size", 100, 50, 800, 10)
-- Visuals end
...
local function custom_scope_overlay()
    ...
    if is_scoped == true then
        ...
        draw.Line(screen_size_x / 2, screen_size_y / 2 - (cslider:GetValue() / 10), screen_size_x / 2, screen_size_y / 2 - cslider:GetValue()) -- top line
        draw.Line(screen_size_x / 2, screen_size_y / 2 + (cslider:GetValue() / 10), screen_size_x / 2, screen_size_y / 2 + cslider:GetValue()) -- bottom line
        draw.Line(screen_size_x / 2 + (cslider:GetValue() / 10), screen_size_y / 2, screen_size_x / 2 + cslider:GetValue(), screen_size_y / 2) -- right line
        draw.Line(screen_size_x / 2 - (cslider:GetValue() / 10), screen_size_y / 2, screen_size_x / 2 - cslider:GetValue(), screen_size_y / 2) -- left line
